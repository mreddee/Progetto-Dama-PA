...
export class blocco{
    ...
    faction: string
    dama: boolean 
    constructor(r:number, c: number, occupied:boolean,occupiedby: string,faction:string, dama: boolean){
        this.r=r;
        this.c=c;
                    ...
                    for(let i = 0; i < dim; i++){
                        ...
                        for(let j = 0; j < dim; j++){
                                if ((i==0 && i%2==0 && j%2==0)||(i==0 && i%2!=0 && j%2!=0)){
                                    this.damiera[i][j] = new blocco(i,j,true,this.pezziNeri[k],"N",false);
                                    k++;
                                }
                                if ((i==3 && i%2==0 && j%2==0)||(i==3 && i%2!=0 && j%2!=0)){
                                    this.damiera[i][j] = new blocco(i,j,true,this.pezziBianchi[k],"B",false);
                                    k++;
                                }
                                else{
                                    this.damiera[i][j] = new blocco(i,j,false,"","",false);
                                }
