 ...
 */
app.post('/create-game', AuthMiddleware.checkHeader, AuthMiddleware.verifySecretKey, AuthMiddleware.authenticateUser, RouteMiddleware.checkEmails, RouteMiddleware.checkGridSize, ControllerMiddleware.checkUsersExistence, ControllerMiddleware.checkUsersTokens, ControllerMiddleware.checkUsersState, ErrorHandlerMiddleware.errorHandler, (req: any, res: any) => {
