...
INSERT INTO public.users (email, username, isadmin, isplaying, token) VALUES
    ('admin@gmail.com','admin',TRUE,FALSE,100)
    ('player1@gmail.com','player1',FALSE,FALSE,10)
    ('player2@gmail.com','player2',FALSE,FALSE,10)
