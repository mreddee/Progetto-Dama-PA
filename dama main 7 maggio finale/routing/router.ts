...
//verifica lo stato di una partita (aggiorna postman)
app.get('/show-game', Middleware_CoR.authentication, Middleware_CoR.catchError, (req: any, res: any) => {
    Controller.showGame(req.body.email, req.body.id_game, res);
});

//determina l'abbandono di un giocatore (aggiorna postman)
