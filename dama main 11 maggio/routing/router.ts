...
//la data iniziale la prende di default dalle 2 di mattina, deve essere un problema del server sql
...
//creata rotta che restituisce lista giochi fatti entro un certo set di date da un certo utente OK
app.get('/games', Middleware_CoR.authentication, Middleware_CoR.userStats, Middleware_CoR.catchError,async (req: any, res: any) => {
   await Controller.getGames(req.body.email, req.body.date_start, req.body.date_end, res);});
