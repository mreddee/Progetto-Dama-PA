...
app.get('/games-per-date', Middleware_CoR.authentication, Middleware_CoR.userStats,Middleware_CoR.gameLog,Middleware_CoR.leaderboard, Middleware_CoR.catchError,async (req: any, res: any) => {
...
app.get('/games-per-moves', Middleware_CoR.authentication, Middleware_CoR.gameLog,Middleware_CoR.leaderboard, Middleware_CoR.catchError,async (req: any, res: any) => {
