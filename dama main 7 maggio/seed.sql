...
INSERT INTO game (id_game, player1, player2, in_progress, date_start, date_end, player_turn, moves1, moves2, winner, pieces1, pieces2, abbandono1, abbandono2, dimensione, board) VALUES
    (1, 'admin@gmail.com', 'player1@gmail.com', FALSE, '2023-05-06', '2023-05-07', 'admin', 6, 5, 'admin', 1, 0, FALSE, FALSE, 3, '{"board":[["/","/","/","/"],["/","/","/","/"],["/","/","/","/"],["/","/","N","/"]]}'),
    (2, 'player1@gmail.com', 'player2@gmail.com', FALSE, '2023-05-02', '2023-05-05', 'player1', 5, 4, 'player1', 1, 0, FALSE, FALSE, 3, '{"board":[["/","/","B","/"],["/","/","/","/"],["/","/","/","/"],["/","/","/","/"]]}');
